...
public class ApplicantManager {
    ...
    //instantiates array of type Applicant
    private Applicant[] applicantArr = new Applicant[100];
    ...
    public void addApplicant(String cID, String fName, String mName,
            String sName, String DOB, String cNumber, String email,
            String pass) {

        applicantArr[size] = new Applicant(cID, fName, mName, sName, DOB,
                cNumber, email, pass);
        size++;
        try {
            //inserts new applicant into database
            ResultSet rs = dbm.queryDatabase("INSERT INTO tblApplicant"
                    + "(firstname" + ", middlename, surname, idnumber, "
                    + "dateofbirth, cellno, " + "email, password) "
                    + "VALUES(" + "'cID'" + "','" + "'fName'"
                    + "','" + "'mName'" + "','" + "'sName'" + "','" + "'DOB'"
                    + "','" + "'cNumber'" + "','" + "'email'" + "','" + "'pass'"
                    + ")");
    ...
    //checks if the name of the applicant and password entered match
    ...
    public void setName(String name, String id) {
        try {
            ResultSet rs = dbm.queryDatabase("UPDATE tblApplicant SET "
                    + "firstname " + "= " + "'name'" + "WHERE idnumber = "
                    + "'id'");
